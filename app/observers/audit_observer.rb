class AuditObserver < ActiveRecord::Observer
  ...
  def after_save(object)
    ...
    unless object.is_a?(Member) && (object.changes.keys - ["perishable_token", "last_request_at", "crypted_password", "updated_at", "password_salt", "current_login_at", "persistence_token", "login_count", "last_login_at", "password_configured"]).size == 0
